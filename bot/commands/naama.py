...
COMMAND_USAGE = "!naama / !naamao / !naamav / !naamay / !naamaa / !naamatarra / !naamatarrao / !naamatarrav / !naamatarray / !naamatarraa [kuva tai vastaus kuvaan]"

LOGGER = logging.getLogger(__name__)
_NAAMA_REGEX = r"(?i)^\s*!(naama(?:o|v|y|a)?|naamatarra(?:o|v|y|a)?)\s*$"
...
def _parse_command(cmd: str) -> tuple[Literal["mirror", "sticker"], Literal["auto", "left", "right", "up", "down"]]:
