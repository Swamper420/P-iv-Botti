...
import bot.commands.thug_logic as thug_logic
...
class ThugLogicTests(unittest.TestCase):
    ...
    def test_compose_thug_image_builds_profile_picture(self) -> None:
        ...
        self.assertEqual(segment_model.last_predict_kwargs.get("conf"), 0.25)
    ...
    def test_compose_thug_image_returns_none_when_person_not_detected(self) -> None:
